...
const StudentDashboard = () => {
  ...
  const fetchSubmissions = useCallback(async (userId) => {
    ...
    // { assignments: [{ assignmentId, assignmentName, isCompleted, subAssignments:[{subAssignmentId,subAssignmentName,isCompleted}], moduleName? }] }
  ...
  const submissions = useMemo(() => {
    ...
    return assignments.map((a) => {
      // Skip entries without assignmentId (like the first one in your example)
      ...
      return {  
        ...
        // Use assignmentName instead of moduleName
                ...
                return (    
                  ...
                  >    
                    <div className="submission-header">    
                      ...
                      <h3>    
                        {/* Show assignmentName from the API */}    

...
const StudentDashboard = () => {
  ...
  const fetchResultData = async (studentId, assignmentId) => {
    try {
      ...
      const response = await api.post('/result', { studentId, assignmentId });
        ...
        {correctQuestions.map((cq, i) => {
          ...
          return (
            <div key={i} className="question-row">
              ...
              <p>
                <strong>Your Answer:</strong> {sq?.answerText || 'N/A'}
              </p>
              <p>
                <strong>Correct Answer:</strong> {cq.correctAnswer || 'N/A'}
              </p>
            </div>
          );
        })}
      ...
      <div className="progress-section">
        <div className="progress-card">
          ...
          <div className="progress-details">
            ...
            <span>
              Assignment Completion {studentData.assignmentCompletion || '0/0'}
            </span>
          </div>
        </div>
      </div>
